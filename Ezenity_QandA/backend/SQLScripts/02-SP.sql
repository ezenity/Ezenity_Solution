...
BEGIN
  ...
  INSERT INTO dbo.Answer (QuestionId, Content, UserId, UserName, Created)
...
BEGIN
  ...
  SELECT a.AnswerId, a.Question, a.Content, u.UserName, a.Created
  FROM dbo.Answer a
...
BEGIN
  ...
  SELECT q.QuestionId, q.Title, q.Content, q.UserName, q.Created, a.QuestionId, a.AnswerId, a.Content, a.UserName, a.Created
  FROM dbo.Question q
